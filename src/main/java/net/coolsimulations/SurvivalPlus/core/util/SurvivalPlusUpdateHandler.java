...
public class SurvivalPlusUpdateHandler {
	...
	public static void init() {
		...
		try {
            URL url = new URL("http://www.coolsimulations.net/mcmods/survivalplus/versionchecker111.txt");
		...
		if(latestVersion != null) {
			...
			if(latestVersion.equals("ended")) {
				...
				updateInfo.getStyle().setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://minecraft.curseforge/projects/survivalplus"));
