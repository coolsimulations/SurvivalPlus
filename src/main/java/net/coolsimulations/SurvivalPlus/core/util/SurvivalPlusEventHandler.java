...
public class SurvivalPlusEventHandler {
	...
	public void coolsimDeath(LivingDeathEvent event) {
		...
		if(event.getEntity() instanceof EntityPlayer && event.getEntity().getDisplayName().getFormattedText().equals("coolsim") && event.getSource().getTrueSource() instanceof EntityPlayer) {
	...
	public static ItemStack getcoolsimHead()
	  {
	    ...
	    TextComponentTranslation headName = new TextComponentTranslation("block.minecraft.player_head.named", new Object[] {"coolsim"});
