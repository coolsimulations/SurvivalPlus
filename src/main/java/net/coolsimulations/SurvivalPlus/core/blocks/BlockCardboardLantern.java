...
public class BlockCardboardLantern extends BlockCardboard implements Waterloggable {
	...
	public boolean canBlockStay(World worldIn, BlockPos pos, BlockState state)
	{
		...
		return ifluidstate.getFluid() == Fluids.WATER || (material == Material.ICE || material == Material.DENSE_ICE) || (iblockstate.getBlock() instanceof CauldronBlock && iblockstate.get(CauldronBlock.LEVEL) == 3);
	}
	...
	protected boolean canFloat(World worldIn, BlockPos pos, Direction direction)
	{
		...
		return direction == Direction.UP && (iblockstate.getBlock() == Blocks.WATER || ((iblockstate.getMaterial() == Material.ICE || iblockstate.getMaterial() == Material.DENSE_ICE) && direction != Direction.DOWN) || (iblockstate.getBlock() instanceof CauldronBlock && iblockstate.get(CauldronBlock.LEVEL) == 3));
	}
