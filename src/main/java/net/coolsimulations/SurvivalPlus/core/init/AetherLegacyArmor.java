...
public class AetherLegacyArmor {
	...
	public static void init(){
		...
		SPItems.skyrootArmorMaterial = EnumHelper.addArmorMaterial("skyroot", SPReference.MOD_ID + ":" +  "skyroot", 20, new int[] {1, 2, 3, 2}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.goldenOakArmorMaterial = EnumHelper.addArmorMaterial("golden_oak", SPReference.MOD_ID + ":" +  "golden_oak", 20, new int[] {1, 2, 3, 2}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
