...
public class SurvivalPlusGeodes {
	...
	private static final RegistryObject<Item> ruby_block_item = ITEMS_GEODE.register("ruby_block", () -> new BlockItem(ruby_block.get(), new Item.Properties()));
	private static final RegistryObject<Item> ruby_cluster_item = ITEMS_GEODE.register("ruby_cluster", () -> new BlockItem(ruby_cluster.get(), new Item.Properties()));
	private static final RegistryObject<Item> large_ruby_bud_item = ITEMS_GEODE.register("large_ruby_bud", () -> new BlockItem(large_ruby_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> medium_ruby_bud_item = ITEMS_GEODE.register("medium_ruby_bud", () -> new BlockItem(medium_ruby_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> small_ruby_bud_item = ITEMS_GEODE.register("small_ruby_bud", () -> new BlockItem(small_ruby_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> budding_ruby_item = ITEMS_GEODE.register("budding_ruby", () -> new BlockItem(budding_ruby.get(), new Item.Properties()));
	private static final RegistryObject<Item> pearl_block_item = ITEMS_GEODE.register("pearl_block", () -> new BlockItem(pearl_block.get(), new Item.Properties()));
	private static final RegistryObject<Item> pearl_cluster_item = ITEMS_GEODE.register("pearl_cluster", () -> new BlockItem(pearl_cluster.get(), new Item.Properties()));
	private static final RegistryObject<Item> large_pearl_bud_item = ITEMS_GEODE.register("large_pearl_bud", () -> new BlockItem(large_pearl_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> medium_pearl_bud_item = ITEMS_GEODE.register("medium_pearl_bud", () -> new BlockItem(medium_pearl_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> small_pearl_bud_item = ITEMS_GEODE.register("small_pearl_bud", () -> new BlockItem(small_pearl_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> budding_pearl_item = ITEMS_GEODE.register("budding_pearl", () -> new BlockItem(budding_pearl.get(), new Item.Properties()));
	private static final RegistryObject<Item> topaz_block_item = ITEMS_GEODE.register("topaz_block", () -> new BlockItem(topaz_block.get(), new Item.Properties()));
	private static final RegistryObject<Item> topaz_cluster_item = ITEMS_GEODE.register("topaz_cluster", () -> new BlockItem(topaz_cluster.get(), new Item.Properties()));
	private static final RegistryObject<Item> large_topaz_bud_item = ITEMS_GEODE.register("large_topaz_bud", () -> new BlockItem(large_topaz_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> medium_topaz_bud_item = ITEMS_GEODE.register("medium_topaz_bud", () -> new BlockItem(medium_topaz_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> small_topaz_bud_item = ITEMS_GEODE.register("small_topaz_bud", () -> new BlockItem(small_topaz_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> budding_topaz_item = ITEMS_GEODE.register("budding_topaz", () -> new BlockItem(budding_topaz.get(), new Item.Properties()));
	private static final RegistryObject<Item> sapphire_block_item = ITEMS_GEODE.register("sapphire_block", () -> new BlockItem(sapphire_block.get(), new Item.Properties()));
	private static final RegistryObject<Item> sapphire_cluster_item = ITEMS_GEODE.register("sapphire_cluster", () -> new BlockItem(sapphire_cluster.get(), new Item.Properties()));
	private static final RegistryObject<Item> large_sapphire_bud_item = ITEMS_GEODE.register("large_sapphire_bud", () -> new BlockItem(large_sapphire_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> medium_sapphire_bud_item = ITEMS_GEODE.register("medium_sapphire_bud", () -> new BlockItem(medium_sapphire_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> small_sapphire_bud_item = ITEMS_GEODE.register("small_sapphire_bud", () -> new BlockItem(small_sapphire_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> budding_sapphire_item = ITEMS_GEODE.register("budding_sapphire", () -> new BlockItem(budding_sapphire.get(), new Item.Properties()));
	private static final RegistryObject<Item> spinel_block_item = ITEMS_GEODE.register("spinel_block", () -> new BlockItem(spinel_block.get(), new Item.Properties()));
	private static final RegistryObject<Item> spinel_cluster_item = ITEMS_GEODE.register("spinel_cluster", () -> new BlockItem(spinel_cluster.get(), new Item.Properties()));
	private static final RegistryObject<Item> large_spinel_bud_item = ITEMS_GEODE.register("large_spinel_bud", () -> new BlockItem(large_spinel_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> medium_spinel_bud_item = ITEMS_GEODE.register("medium_spinel_bud", () -> new BlockItem(medium_spinel_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> small_spinel_bud_item = ITEMS_GEODE.register("small_spinel_bud", () -> new BlockItem(small_spinel_bud.get(), new Item.Properties()));
	private static final RegistryObject<Item> budding_spinel_item = ITEMS_GEODE.register("budding_spinel", () -> new BlockItem(budding_spinel.get(), new Item.Properties()));
	
	private static final RegistryObject<Item> ruby_shard = ITEMS_GEODE.register("ruby_shard", () -> new Item(new Item.Properties()));
	private static final RegistryObject<Item> pearl = ITEMS_GEODE.register("pearl", () -> new Item(new Item.Properties()));
	private static final RegistryObject<Item> topaz_shard = ITEMS_GEODE.register("topaz_shard", () -> new Item(new Item.Properties()));
	private static final RegistryObject<Item> sapphire_shard = ITEMS_GEODE.register("sapphire_shard", () -> new Item(new Item.Properties()));
	private static final RegistryObject<Item> spinel_shard = ITEMS_GEODE.register("spinel_shard", () -> new Item(new Item.Properties()));
