	...
	public static void registerFeature(BiomeGenerationSettingsBuilder gen, Biome.BiomeCategory category) {
		...
		if (category == BiomeCategory.NETHER) {
			if(!SPConfig.disableRubyGen.get()) {
				gen.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, Feature.GEODE.configured(new GeodeConfiguration(new GeodeBlockSettings(BlockStateProvider.simple(Blocks.AIR.defaultBlockState()), BlockStateProvider.simple(SPBlocks.ruby_block.defaultBlockState()), BlockStateProvider.simple(SPBlocks.budding_ruby.defaultBlockState()), BlockStateProvider.simple(Blocks.CALCITE.defaultBlockState()), BlockStateProvider.simple(Blocks.MAGMA_BLOCK.defaultBlockState()), ((SPBlockCrystalBudding) SPBlocks.budding_ruby).getStates(), BlockTags.FEATURES_CANNOT_REPLACE.getName(), BlockTags.GEODE_INVALID_BLOCKS.getName()), new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1)).placed(RarityFilter.onAverageOnceEvery(24), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()), BiomeFilter.biome()));
			}
			if(!SPConfig.disableTopazGen.get()) {
				gen.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, Feature.GEODE.configured(new GeodeConfiguration(new GeodeBlockSettings(BlockStateProvider.simple(Blocks.AIR.defaultBlockState()), BlockStateProvider.simple(SPBlocks.topaz_block.defaultBlockState()), BlockStateProvider.simple(SPBlocks.budding_topaz.defaultBlockState()), BlockStateProvider.simple(Blocks.CALCITE.defaultBlockState()), BlockStateProvider.simple(Blocks.MAGMA_BLOCK.defaultBlockState()), ((SPBlockCrystalBudding) SPBlocks.budding_topaz).getStates(), BlockTags.FEATURES_CANNOT_REPLACE.getName(), BlockTags.GEODE_INVALID_BLOCKS.getName()), new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1)).placed(RarityFilter.onAverageOnceEvery(24), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()), BiomeFilter.biome()));
			}
			if(!SPConfig.disableSapphireGen.get()) {
				gen.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, Feature.GEODE.configured(new GeodeConfiguration(new GeodeBlockSettings(BlockStateProvider.simple(Blocks.AIR.defaultBlockState()), BlockStateProvider.simple(SPBlocks.sapphire_block.defaultBlockState()), BlockStateProvider.simple(SPBlocks.budding_sapphire.defaultBlockState()), BlockStateProvider.simple(Blocks.CALCITE.defaultBlockState()), BlockStateProvider.simple(Blocks.MAGMA_BLOCK.defaultBlockState()), ((SPBlockCrystalBudding) SPBlocks.budding_sapphire).getStates(), BlockTags.FEATURES_CANNOT_REPLACE.getName(), BlockTags.GEODE_INVALID_BLOCKS.getName()), new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1)).placed(RarityFilter.onAverageOnceEvery(24), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()), BiomeFilter.biome()));
			}
		} else if (category != BiomeCategory.THEEND) {

			if(category == BiomeCategory.OCEAN && !SPConfig.disablePearlGen.get()) {
				gen.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, Feature.GEODE.configured(new GeodeConfiguration(new GeodeBlockSettings(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), BlockStateProvider.simple(SPBlocks.pearl_block.defaultBlockState()), BlockStateProvider.simple(SPBlocks.budding_pearl.defaultBlockState()), BlockStateProvider.simple(Blocks.CALCITE.defaultBlockState()), BlockStateProvider.simple(Blocks.SMOOTH_BASALT.defaultBlockState()), ImmutableList.of(((SPBlockCrystalBudding) SPBlocks.budding_pearl).getStates().get(0).setValue(BlockStateProperties.WATERLOGGED, true), ((SPBlockCrystalBudding) SPBlocks.budding_pearl).getStates().get(1).setValue(BlockStateProperties.WATERLOGGED, true), ((SPBlockCrystalBudding) SPBlocks.budding_pearl).getStates().get(2).setValue(BlockStateProperties.WATERLOGGED, true), ((SPBlockCrystalBudding) SPBlocks.budding_pearl).getStates().get(3).setValue(BlockStateProperties.WATERLOGGED, true)), BlockTags.FEATURES_CANNOT_REPLACE.getName(), BlockTags.GEODE_INVALID_BLOCKS.getName()), new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1)).placed(RarityFilter.onAverageOnceEvery(24), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(64), VerticalAnchor.absolute(63)), BiomeFilter.biome()));
			}

			if(category == BiomeCategory.MUSHROOM && !SPConfig.disableSpinelGen.get()) {
				gen.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, Feature.GEODE.configured(new GeodeConfiguration(new GeodeBlockSettings(BlockStateProvider.simple(Blocks.AIR.defaultBlockState()), BlockStateProvider.simple(SPBlocks.spinel_block.defaultBlockState()), BlockStateProvider.simple(SPBlocks.budding_spinel.defaultBlockState()), BlockStateProvider.simple(Blocks.CALCITE.defaultBlockState()), BlockStateProvider.simple(Blocks.SMOOTH_BASALT.defaultBlockState()), ((SPBlockCrystalBudding) SPBlocks.budding_spinel).getStates(), BlockTags.FEATURES_CANNOT_REPLACE.getName(), BlockTags.GEODE_INVALID_BLOCKS.getName()), new GeodeLayerSettings(1.7D, 2.2D, 3.2D, 4.2D), new GeodeCrackSettings(0.95D, 2.0D, 2), 0.35D, 0.083D, true, UniformInt.of(4, 6), UniformInt.of(3, 4), UniformInt.of(1, 2), -16, 16, 0.05D, 1)).placed(RarityFilter.onAverageOnceEvery(24), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.aboveBottom(64)), BiomeFilter.biome()));
			}
		}
	}
