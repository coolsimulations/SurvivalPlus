...
public class BOPArmor {
	...
	public static void init(){
		...
		SPItems.cherryArmorMaterial = EnumHelper.addArmorMaterial("cherry", SPReference.MOD_ID + ":" +  "cherry", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.deadArmorMaterial = EnumHelper.addArmorMaterial("dead", SPReference.MOD_ID + ":" +  "dead", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.ebonyArmorMaterial = EnumHelper.addArmorMaterial("ebony", SPReference.MOD_ID + ":" +  "ebony", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.etherealArmorMaterial = EnumHelper.addArmorMaterial("ethereal", SPReference.MOD_ID + ":" +  "ethereal", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.eucalyptusArmorMaterial = EnumHelper.addArmorMaterial("eucalyptus", SPReference.MOD_ID + ":" +  "eucalyptus", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.firArmorMaterial = EnumHelper.addArmorMaterial("fir", SPReference.MOD_ID + ":" +  "fir", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.hellbarkArmorMaterial = EnumHelper.addArmorMaterial("hellbark", SPReference.MOD_ID + ":" +  "hellbark", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.jacarandaArmorMaterial = EnumHelper.addArmorMaterial("jacaranda", SPReference.MOD_ID + ":" +  "jacaranda", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.magicArmorMaterial = EnumHelper.addArmorMaterial("magic", SPReference.MOD_ID + ":" +  "magic", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.mahoganyArmorMaterial = EnumHelper.addArmorMaterial("mahogany", SPReference.MOD_ID + ":" +  "mahogany", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.mangroveArmorMaterial = EnumHelper.addArmorMaterial("mangrove", SPReference.MOD_ID + ":" +  "mangrove", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.palmArmorMaterial = EnumHelper.addArmorMaterial("palm", SPReference.MOD_ID + ":" +  "palm", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.pineArmorMaterial = EnumHelper.addArmorMaterial("pine", SPReference.MOD_ID + ":" +  "pine", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.redwoodArmorMaterial = EnumHelper.addArmorMaterial("redwood", SPReference.MOD_ID + ":" +  "redwood", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.sacredOakArmorMaterial = EnumHelper.addArmorMaterial("sacred_oak", SPReference.MOD_ID + ":" +  "sacred_oak", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.umbranArmorMaterial = EnumHelper.addArmorMaterial("umbran", SPReference.MOD_ID + ":" +  "umbran", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.willowArmorMaterial = EnumHelper.addArmorMaterial("willow", SPReference.MOD_ID + ":" +  "willow", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
