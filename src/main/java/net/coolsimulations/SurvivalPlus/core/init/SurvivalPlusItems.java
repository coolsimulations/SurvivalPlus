...
public class SurvivalPlusItems {
	...
	public static void init() {
		...
		SPItems.charcoal_bucket = new Item().setUnlocalizedName("charcoal_bucket").setRegistryName("charcoal_bucket").setMaxStackSize(1).setCreativeTab(SPTabs.tabMaterials);
