...
public class SurvivalPlusArmor {
	...
	public static void init(){
		...
		SPItems.bronzeArmorMaterial = EnumHelper.addArmorMaterial("bronze", SPReference.MOD_ID + ":" +  "bronze", 20, new int[] {2, 5, 5, 2}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
		...
		SPItems.stoneArmorMaterial = EnumHelper.addArmorMaterial("stone", SPReference.MOD_ID + ":" +  "stone", 20, new int[] {1, 2, 4, 2}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.oakArmorMaterial = EnumHelper.addArmorMaterial("oak", SPReference.MOD_ID + ":" +  "oak", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.spruceArmorMaterial = EnumHelper.addArmorMaterial("spruce", SPReference.MOD_ID + ":" +  "spruce", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.birchArmorMaterial = EnumHelper.addArmorMaterial("birch", SPReference.MOD_ID + ":" +  "birch", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.jungleArmorMaterial = EnumHelper.addArmorMaterial("jungle", SPReference.MOD_ID + ":" +  "jungle", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.acaciaArmorMaterial = EnumHelper.addArmorMaterial("acacia", SPReference.MOD_ID + ":" +  "acacia", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		SPItems.darkOakArmorMaterial = EnumHelper.addArmorMaterial("dark_oak", SPReference.MOD_ID + ":" +  "dark_oak", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		if (OreDictionary.getOres("woodRubber").size() > 0) {
			...
			SPItems.rubberArmorMaterial = EnumHelper.addArmorMaterial("rubber", SPReference.MOD_ID + ":" + "rubber", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
		...
		if(SPCompatibilityManager.isBambooModsLoaded()) {
			...
			SPItems.bambooArmorMaterial = EnumHelper.addArmorMaterial("bamboo", SPReference.MOD_ID + ":" +  "bamboo", 20, new int[] {1, 2, 2, 1}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
			SPItems.bamboo_helmet = new SPItemArmor(SPItems.bambooArmorMaterial, 0, EntityEquipmentSlot.HEAD, "bamboo_helmet", "stickWood").setUnlocalizedName("bamboo_helmet").setRegistryName("bamboo_helmet").setCreativeTab(SPTabs.tabCombat);
			SPItems.bamboo_chestplate = new SPItemArmor(SPItems.bambooArmorMaterial, 0, EntityEquipmentSlot.CHEST, "bamboo_chestplate", "stickWood").setUnlocalizedName("bamboo_chestplate").setRegistryName("bamboo_chestplate").setCreativeTab(SPTabs.tabCombat);
			SPItems.bamboo_leggings = new SPItemArmor(SPItems.bambooArmorMaterial, 0, EntityEquipmentSlot.LEGS, "bamboo_leggings", "stickWood").setUnlocalizedName("bamboo_leggings").setRegistryName("bamboo_leggings").setCreativeTab(SPTabs.tabCombat);
			SPItems.bamboo_boots = new SPItemArmor(SPItems.bambooArmorMaterial, 0, EntityEquipmentSlot.FEET, "bamboo_boots", "stickWood").setUnlocalizedName("bamboo_boots").setRegistryName("bamboo_boots").setCreativeTab(SPTabs.tabCombat);
