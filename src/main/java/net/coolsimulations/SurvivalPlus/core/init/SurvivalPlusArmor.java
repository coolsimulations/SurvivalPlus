...
public class SurvivalPlusArmor {
	...
	public static void init(){
		...
		SPItems.bronze = Lists.newArrayList();
		...
		SPItems.stone = Lists.newArrayList();
		...
		SPItems.titanium = Lists.newArrayList();
		...
		SPItems.oak = Lists.newArrayList();
		...
		SPItems.spruce = Lists.newArrayList();
		...
		SPItems.birch = Lists.newArrayList();
		...
		SPItems.jungle = Lists.newArrayList();
		...
		SPItems.acacia = Lists.newArrayList();
		...
		SPItems.dark_oak = Lists.newArrayList();
		...
		if (OreDictionary.getOres("woodRubber").size() > 0) {
			...
			SPItems.rubber = Lists.newArrayList();
	...
	public static void register(List<ItemStack> item)
	{
	...
	public static void registerRender(List<ItemStack> item)
	{
		for(int i = 0; i < item.size(); i++) {
