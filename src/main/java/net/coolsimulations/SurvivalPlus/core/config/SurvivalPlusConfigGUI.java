...
public class SurvivalPlusConfigGUI {
	...
	public static Screen getConfigScreen(Screen parent)
	{
		...
		generation.addEntry(entryBuilder.startBooleanToggle(new TranslatableComponent("sp.configgui.disable_copper_ore_gen"), SPConfig.disableCopperOreGen).setTooltip(new TranslatableComponent("sp.configgui.disable_copper_ore_gen")).setDefaultValue(false).setSaveConsumer(newValue->SPConfig.disableCopperOreGen = newValue).build());
		...
		generation.addEntry(entryBuilder.startBooleanToggle(new TranslatableComponent("sp.configgui.disable_amethyst_gen"), SPConfig.disableAmethystGen).setTooltip(new TranslatableComponent("sp.configgui.disable_amethyst_gen")).setDefaultValue(false).setSaveConsumer(newValue->SPConfig.disableAmethystGen = newValue).build());
		...
		compatibility.addEntry(entryBuilder.startBooleanToggle(new TranslatableComponent("sp.configgui.sun_audio"), SPConfig.disableSunAudio).setTooltip(new TranslatableComponent("sp.configgui.sun_audio")).setDefaultValue(false).setSaveConsumer(newValue->SPConfig.disableSunAudio = newValue).build());
