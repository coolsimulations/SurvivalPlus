...
public class SurvivalPlusNoTreePunching {
	...
	public static void init() {
		...
		SPItems.titanium_knife = new KnifeItem(SPItemTier.titaniumToolMaterial, 1, -2.2F, new FabricItemSettings());
		SPItems.titanium_mattock = new MattockItem(SPItemTier.titaniumToolMaterial, 0.5F, -2.2F, new FabricItemSettings());
		SPItems.titanium_saw = new AxeItem(SPItemTier.titaniumToolMaterial, 3.0F, -3.2F, new FabricItemSettings());
	}
