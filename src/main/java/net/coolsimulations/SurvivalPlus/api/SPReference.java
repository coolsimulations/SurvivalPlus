...
public class SPReference {
	...
	public static final String VERSION = "0.1.5c";
	public static final String ACCEPTED_VERSIONS = "[1.16, 1.16.2, 1.16.3, 1.16.4, 1.16.5]";
	...
	public static final String DEPENDENCIES_FORGE = "required-after:forge@[36.1.20,);";
