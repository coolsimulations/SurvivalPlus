...
public class SPOreFeature extends OreFeature {
	
	public static final Feature<OreFeatureConfig> SURVIVALPLUS_ORE_FEATURE = Registry.register(Registry.FEATURE,
            new Identifier(SPReference.MOD_ID, "sp_ore"), new SPOreFeature(OreFeatureConfig::deserialize));

	public SPOreFeature(Function<Dynamic<?>, ? extends OreFeatureConfig> configFactory) {
		super(configFactory);
	}
	                        ...
	                        for(int ak = ac; ak <= af; ++ak) {
	                           ...
	                           if (ah * ah + aj * aj + al * al < 1.0D) {
	                              ...
	                              if (!bitSet.get(am)) {
	                                 ...
	                                 SPOreFeatureConfig spConfig = (SPOreFeatureConfig) config;
                                     if (spConfig.blockPredicate.test(world.getBlockState(mutable))) {
